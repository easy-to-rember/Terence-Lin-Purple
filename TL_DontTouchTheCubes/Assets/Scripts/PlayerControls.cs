...
public class PlayerControls : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Time.timeScale = 1f; //game is at normal pace
    }
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(Mathf.Clamp(transform.position.x, -30f, 30f), //the position of the GameObject's transform component is assigned a newly created Vector3
